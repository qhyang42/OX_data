...
group_mean_fisher_z_matrix = squeeze(mean( ...
    mean_fisher_z_matrix, 1, 'omitnan'));
...
if n_permutations > 0
    group_null_mean_delta_z = squeeze(mean( ...
        subject_null_mean_delta_z, 1, 'omitnan'));
    group_null_mean_max_delta_z = squeeze(mean( ...
        subject_null_max_delta_z, 1, 'omitnan'));
    group_null_context_delta_z = squeeze(mean( ...
        subject_null_context_delta_z, 1, 'omitnan'));
else
...
group_observed_context_delta_z = squeeze(mean( ...
    subject_context_delta_z, 1, 'omitnan'));
